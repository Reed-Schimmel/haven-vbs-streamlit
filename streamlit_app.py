...
# page 10 of PDF v4
mcap_vbs = math.exp((mcap_ratio + math.sqrt(mcap_ratio)) * 2) - 0.5 if mcap_ratio < 0.9 else \
...
# TODO: offshore slippage page 12
# slippage_vbs = math.sqrt(mcap)
...
#         "XHV Mcap ($)": xhv_mcap,
#         "xAssets Mcap ($)": xassets_mcap,
#         # "XHV Mcap": f"${xhv_price * xhv_supply}",
#         # "xAssets Mcap": f"${xassets_mcap}",
#         "Mcap Ratio": mcap_ratio,
#         "Spread Ratio": "TODO",
#         "Mcap VBS": mcap_vbs,
#         "Spread VBS": "TODO",
